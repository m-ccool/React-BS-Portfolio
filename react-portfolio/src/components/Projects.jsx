            ...
            <h1 class="d-flex h-section">projects</h1>
                ...
                <div class="row row-cols-1 row-cols-sm-1 row-cols-md-2 row-cols-lg-2 row-cols-xl-3 d-flex justify-content-center" id="card-row">
                    ...
                    <div class="text-center d-flex align-items-start align-items-xxl-start app-card" id="app-card-1">
                        <i class="fas fa-headphones-alt app-card-icon"></i>
                    ...
                    <div class="col-auto justify-content-center app-col">
                    <div class="text-center d-flex align-items-start align-items-xxl-start app-card" id="app-card-1">
                        <Icon icon="tabler:plant-2" class="app-card-icon" />
                        <img class="d-inline-flex flex-shrink-1 app-card-img" src="./assets/img/A-New-Leaf-Capture.PNG"></img>
                        <h2>A New Leaf</h2>
                    ...
                    <div class="col-auto justify-content-center app-col">
                    <div class="text-center d-flex align-items-start align-items-xxl-start app-card" id="app-card-1">
                        <Icon icon="bi:bounding-box" class="app-card-icon" />
                        <img class="d-inline-flex flex-shrink-1 app-card-img" src="./assets/img/watch-that-box-preview.png"></img>
                        <h2>Flexbox Demo</h2>
                    ...
                    <div class="col-auto justify-content-center app-col">
                    <div class="text-center d-flex align-items-start align-items-xxl-start app-card" id="app-card-1">
                        <Icon icon="uil:cloud" class="app-card-icon" />
                        <img class="d-inline-flex flex-shrink-1 app-card-img" src="./assets/img/weatherdashboarrd-api-screenshot.png"></img>
                    ...
                    <div class="text-center d-flex align-items-start align-items-xxl-start app-card" id="app-card-1">
                        ...
                        <img class="d-inline-flex flex-shrink-1 app-card-img"  alt="img" src="./assets/img/javascript-timed-quiz-preview.png"></img>
